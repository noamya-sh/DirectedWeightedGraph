    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()== TspITEM) {
            ...
            find.addActionListener(e14 -> {
                ...
                for (int i = 0; i < nodes2.getItemCount(); i++) send.add(((Graph)panel.dg.getGraph()).getNodeHash().get(nodes2.getItemAt(i)));
        ...
        if (e.getSource()==removeEdge){
            ...
            nodes1.addActionListener(e17 -> {
                ...
                for (int id : ((Node) ((Graph)panel.dg.getGraph()).getNodeHash().get(x)).getEdges().keySet()) nodes2.addItem(id);
                contain.validate();
                contain.repaint();
                setVisible(true);
            });
